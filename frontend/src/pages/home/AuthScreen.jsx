...
const AuthScreen = () => {
  ...
  return (
    <div className="hero-bg relative">
      ...
      {/* hero section */}
      <div className="flex flex-col justify-center items-center text-center py-40 text-violet-200 max-w-6xl mx-auto">
        ...
        <form
          className="flex flex-col md:flex-row justify-center gap-4 w-1/2"
      ...
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl flex-col mx-auto items-center justify-center md:flex-row px-4 md:px-2">
          {/* left side */}
